...
$(function(){
	//获得ul的宽度
	var maincontent_navi=$(".maincontent_navi").outerWidth();
	//两边间距
	var maincontent_navi_left=maincontent_navi/2;
	$('.maincontent_navi').css("margin-left",-maincontent_navi_left);
	});
  ...
  var mainin = {
        ...
        hotflagslider : function(){
            ...
            $('.hotarrowbtn .hot_pre').click(function(){
                ...
                if(onOff){
                    onOff = false;
                    $('.hotflagbox').animate({'left':parseInt($('.hotflagbox').css('left'))+liLength+'px'},function(){
                        onOff = true;
                    });  
                }
        ...
        starstyle : function(){
    		...
    		//alert('你是使用IE');
			$(".darwin_3colum div").removeClass('imgCol1Hover');
			$(".darwin_3colum div dt").removeClass('imageCover');
			$(".darwin_3colum div dt").css('display','none');
			...
			$(".darwin_3colum div").addClass('imgCol1Hover');
			$(".darwin_3colum div dt").addClass('imageCover');
			$(".darwin_3colum div dt").css('display','block');
		}
        }
    };
